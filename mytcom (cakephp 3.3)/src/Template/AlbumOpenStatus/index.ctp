    ...
    <body>
        <div id="wrapper">
            ...
            <div id="mainContents">
                ...
                <div id="messageArea"><h1 class="iconAlbum">アルバム</h1></div>
                ...
                <div id="contentsRight">
                    <div class="contentsBox">
                        <div class="contentsTopGray">
                            ...
                            <?php if ($helpLinkUrl['AlbumOpenStatus']) : ?>
                                <div class="searchAreaN floR">
                                <a class="iconHelp" href="<?php echo $helpLinkUrl['AlbumOpenStatus'] ?>" target="_blank">この機能のヘルプ</a>
                                </div>
                            <?php endif;?>
                        </div>
                        <div class="contentsMain">
                            <div class="bdrbot padArea space_4">
                                ...
                                <span class="txtRed"><?= $abssmessage ?></span>
                                <?php endif; ?>
                                <h3 class="txtBold"><?= h($openfname['album_name']) ?>の公開状況</h3>
                            </div>
                            ...
                            <div class="floR txtRight" style="width:680px;height:1.1em;">
                                <form name="selection" action="?<?= $cashe ?>" method="GET">
                                    ...
                                    <?php echo $this->Form->select(
                                        'pid',
                                        $contents,
                                        ['class' => 'selectFile', 'default' => $selectedPicture]
                                    ); ?>
                                        <input type="hidden" name="aid" value="<?= $aid ?>">
                                        <input type="submit" name="album_select" value="表示" class="submit01 btnstd" />
                                </form>
                            </div>
                            <div class="clear"></div>
                            <table id="table" align="center" cellpadding="0" cellspacing="0" class="tblPicList">
                                ...
                                <form name="delete_open" action="?pid=<?= $selectedPicture ?>&aid=<?= $aid ?>&<?= $cashe ?>" method="POST">
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <ul class="liststyleC">
                                                <?php if ($list['open_type'] == 3) :  ?>
                                                    <input type="hidden" name="pic_mode" value="1">
                                                ...
                                                <?php else : ?>
                                                    アルバム一式
                                                    <input type="hidden" name="pic_mode" value="0">
                                                <?php endif; ?>
                                            </ul>
                                        </td>
                                        <td>
                                        ...
                                        <td style="padding-left:10px;width:70px;">
                                            ...
                                            <input type="hidden" name="aid" value="<?= $aid ?>" />
                                            <input type="hidden" name="pid" value="<?= $selectedPicture ?>">
