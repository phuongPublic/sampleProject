@extends('layouts.supply_company')
@section('content')
    @include('supply_side.company.company_modal')
    <!-- Full Width Column -->
        ...
        <div class="container">
            ...
            <section class="content">
                <div class="box box-info">
                    ...
                    <!-- form start -->
                    <form class="form-horizontal register_form" method="post" href="{{route('company')}}" name="register_form" id="company_register_form">
                    {{ csrf_field() }}
                        ...
                        <div class="box-footer text-center">
                            <div class="form-group text-center">
                                <button type="submit"  class="btn btn-info center-block bg_blue text-light mgb-10">{{__('supply.company.submit_btn')}}</button>
                            </div>
                        </div>
                        <!-- /.box-footer -->
                    </form>
