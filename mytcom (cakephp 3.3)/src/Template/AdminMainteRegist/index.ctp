                ...
                <div id="BackgroundRight_repeat">
                    <div id="BackgroundLeft">
                        <div id="BackgroundRight">
                            <div id="siteNavi">
                                <div id="topicPath"><span><a href="/admin/index.html">トップ</a></span>&nbsp;&gt;&nbsp;<span>メンテナンス画面の作成</span></div>
                            </div>
                            <div id="wrap">
                                        ...
                                        <td id="main">
                                            <div class="mainBox">
                                                <div class="titlebarMain_bg">
                                                    <h2 class="titlebarMain_icon">メンテナンス画面の作成</h2>
                                                </div>
                                                <p class="mBoxitem_txt">メンテナンス画面の表示設定を行います。<br />
                                                ...
                                                <div class="mBoxitem_table">
                                                    <form id="mainteRegForm" method="post" name="mainteform" action="/admin/mainte/regist.html">
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <div class="fAssist_col_line">
                                                                        ...
                                                                        $this->Form->year('mainte_start_time', [
                                                                            ...
                                                                            'maxYear' => date("Y") + 3,
                                                                            'value' => (isset($mainteObj['mainte_start_time'])) ? date("Y", strtotime($mainteObj["mainte_start_time"])) : date("Y"),
                                                                            'empty' => false,
                                                                            'orderYear' => 'asc',
                                                                        ...
                                                                        $this->Form->month('mainte_start_time', [
                                                                            'monthNames' => false,
                                                                            'value' => (isset($mainteObj['mainte_start_time'])) ? date("m", strtotime($mainteObj["mainte_start_time"])) : date("m"),
                                                                            'empty' => false,
                                                                            'class' => 'mainte_start_time',
                                                                        ...
                                                                        $this->Form->day('mainte_start_time', [
                                                                            'value' => (isset($mainteObj['mainte_start_time'])) ? date("d", strtotime($mainteObj["mainte_start_time"])) : date("d"),
                                                                            'empty' => false,
                                                                            'class' => 'mainte_start_time',
                                                                            'leadingZeroValue' => true]);
                                                                        ?>
                                                                        ...
                                                                        $this->Form->hour('mainte_start_time', [
                                                                            'value' => (isset($mainteObj['mainte_start_time'])) ? date("H", strtotime($mainteObj["mainte_start_time"])) : date("H"),
                                                                            'empty' => false,
                                                                            'class' => 'mainte_start_time',
                                                                            'leadingZeroValue' => true]);
                                                                        ?>
                                                                        ...
                                                                        $this->Form->minute('mainte_start_time', [
                                                                            'value' => (isset($mainteObj['mainte_start_time'])) ? date("i", strtotime($mainteObj["mainte_start_time"])) : date("i"),
                                                                            'empty' => false,
                                                                            'class' => 'mainte_start_time',
                                                                            'leadingZeroValue' => true]);
                                                                        ?>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <div class="fAssist_col_line">
                                                                        ...
                                                                        $this->Form->year('mainte_end_time', [
                                                                            'minYear' => Configure::read('Common.AdminModule.Datetime.DefaultSelected.Year'),
                                                                            'maxYear' => date("Y") + 3,
                                                                            'value' => (isset($mainteObj['mainte_end_time'])) ? date("Y", strtotime($mainteObj["mainte_end_time"])) : date("Y"),
                                                                            'empty' => false,
                                                                            'orderYear' => 'asc',
                                                                        ...
                                                                        $this->Form->month('mainte_end_time', [
                                                                            'monthNames' => false,
                                                                            'value' => (isset($mainteObj['mainte_end_time'])) ? date("m", strtotime($mainteObj["mainte_end_time"])) : date("m"),
                                                                            'empty' => false,
                                                                            'class' => 'mainte_end_time',
                                                                            'leadingZeroValue' => true]);
                                                                        ?>
                                                                        ...
                                                                        $this->Form->day('mainte_end_time', [
                                                                            'value' => (isset($mainteObj['mainte_end_time'])) ? date("d", strtotime($mainteObj["mainte_end_time"])) : date("d"),
                                                                            'empty' => false,
                                                                            'class' => 'mainte_end_time',
                                                                            'leadingZeroValue' => true]);
                                                                        ?>
                                                                        ...
                                                                        $this->Form->hour('mainte_end_time', [
                                                                            'value' => (isset($mainteObj['mainte_end_time'])) ? date("H", strtotime($mainteObj["mainte_end_time"])) : date("H"),
                                                                            'empty' => false,
                                                                            'class' => 'mainte_end_time',
                                                                            'leadingZeroValue' => true]);
                                                                        ?>
                                                                        ...
                                                                        $this->Form->minute('mainte_end_time', [
                                                                            'value' => (isset($mainteObj['mainte_end_time'])) ? date("i", strtotime($mainteObj["mainte_end_time"])) : date("i"),
                                                                            'empty' => false,
                                                                            'class' => 'mainte_end_time',
                                                                            'leadingZeroValue' => true]);
                                                                        ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="padding-bottom: 7px">
                                                                    <?php if (isset($errors['mainte_body'])) { ?>
                                                                        ...
                                                                        <?php } ?>
                                                                    <?php } ?>
                                                                    <textarea class="txt_bigbox" style="height:250px;" onkeydown="ignoreESC(this, event.keyCode)" onfocus="toggleColorBig(this)" onblur="toggleColorBig(this)" name="mainte_body" rows="10" cols=""><?php if(isset($mainteObj["mainte_body"])) echo $mainteObj["mainte_body"]; ?></textarea></td>
                                                            </tr>
                                                        </table>
                                                        <div class="BtnArea">
                                                            <div class="BtnAreaitem">
                                                                <input type="submit" id="toggleSubmit" class="btnNormal_xbig" title="書き込み内容をよく確認してから登録する" value="書き込み内容をよく確認してから登録する" name="mainteRegSubmit" />
                                                            </div>
                                                            <div class="BtnAreaitem">
