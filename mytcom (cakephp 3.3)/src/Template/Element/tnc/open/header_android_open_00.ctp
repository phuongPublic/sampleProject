...
?>
    ...
    <link rel="stylesheet" href="/contents/android/tnc/css/common.css" type="text/css">
    ...
    <script type="application/x-javascript" src="/contents/android/tnc/iui/iui.js"></script>
    <link rel="stylesheet" href="/contents/android/tnc/iui/iui.css" type="text/css" />