...
?>
<div id="logo"><a href="/index.html?<?= $cashe ?>" name="top"><img src="/contents/images/tnc/logo.gif" alt="TNCポケット" /></a></div>
<div id="login"><p><a href="http://www.tnc.ne.jp/" target="_blank">TNCトップ</a>｜<a href="http://www.tnc.ne.jp/support/" target="_blank">会員サポート</a>｜<a href="http://www.tnc.ne.jp/pocket/pt_05.html" target="_blank">ヘルプ</a></p>｜<p><a href="/logout.html?<?= $cashe ?>>">[ログアウト]</a></p></div>
<br />
