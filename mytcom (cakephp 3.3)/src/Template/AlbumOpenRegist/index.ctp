                ...
                <div id="contentsRight">
                    <div class="contentsBox">
                        <div class="contentsTopGray">
                            <h3 class="contentsttl floL">写真を公開する</h3>
                            <?php if ($helpLinkUrl['AlbumOpenRegist']) : ?>
                                <div class="searchAreaN floR">
                                <a class="iconHelp" href="<?php echo $helpLinkUrl['AlbumOpenRegist'] ?>" target="_blank">この機能のヘルプ</a>
                                </div>
                            <?php endif;?>
                        </div>
                        <div class="contentsMain">
                            <div class="bdrbot padArea">
                                ...
                                <?php endif; ?>
                                <h3>写真の公開ページのURLを指定したメールアドレス宛に送信することができます。</h3>
                            ...
                            <form id="form" class="submitForm" name="form1" method="post" action="regist.html?return=1&<?= $cashe ?>">
                                <table align="center" cellpadding="0" cellspacing="0" class="tblForm">
                                    <tr>
                                        <th class="short">公開する写真</th>
                                        <?php if ($openflg == 1) : ?>
                                        <td>
                                            <?php if (isset($openAlbumName)) : ?>
                                            <?= $this->Common->mbwordwrap(h($openAlbumName['album_name'])); ?>
                                            <?php endif; ?> 一式
                                        </td>
                                        <?php else : ?>
                                        <td>
                                            <ul class="liststyleC" style="margin-left:-5px;">
                                                <?php if (isset($aOpenRegInput['picName'])) : ?>
                                                    <?php foreach (array_reverse($aOpenRegInput['picName']) as $pic) : ?>
                                                <li><div style="word-wrap: break-word; width:480px;"><span><?= h($pic); ?></span></div></li>
                                                    <?php endforeach; ?>
                                                <?php endif; ?>
                                            </ul>
                                        </td>
