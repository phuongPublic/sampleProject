...
class CelebrationMoneyExport3 implements FromView, ShouldAutoSize
{
    /**
     * @return View
     */
    public function view(): View
    {
        ...
        if (!empty($pr)) {
            ...
            $celebrationMoney = CelebrationMoney::getList(0, 0, 1, $startTime, $endTime);
        } else {
            $celebrationMoney = CelebrationMoney::getList(0, 0, 1);
        }
