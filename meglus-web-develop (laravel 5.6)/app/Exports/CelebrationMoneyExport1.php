...
class CelebrationMoneyExport1 implements FromView, ShouldAutoSize
{
    /**
     * @return View
     */
    public function view(): View
    {
        ...
        if (!empty($pr)) {
            ...
            $celebrationMoney = CelebrationMoney::getList(1, 1, 1, $startTime, $endTime);
        } else {
            $celebrationMoney = CelebrationMoney::getList(1, 1, 1);
        }
