...
/**
 * App\Controller\OpenPictureController Test Case
 */
class OpenPictureControllerTest extends NoptIntegrationTestCase
{
    ...
    {
        $this->switchDevice(1);
        $this->get($this->testUrl . '?id=openid_pic&pid=1');
    ...
    public function indexProcess()
    {
        ...
        $this->post($this->testUrl.'?id=openid_pic&pid=1', $data);
        $this->assertResponseCode(302);
    }
