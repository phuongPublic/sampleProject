...
<html>
    ...
    <body>
        ...
        <ul id="logout" title="エラー" class="panel" selected="true">
            ...
            <div class="button3"><a class="grayButton" type="button" href="/android/login.html" target="_self">ログインページへ</a></div>
            <div id="footer">
                <ul id="footerMenu">
            <?php $siteSetting = $this->Common->getSiteSetting(); ?>
                ...
                <div id="switchView">
                    <a href="/login.html" target="_blank"><img src="/contents/android/tcom/images/icon_pc.png" />パソコン版で表示する</a>
                </div>
                <div id="footerBottom">
