    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content" style="width: 1000px;">
            <div class="modal-header text-right">
                <div class="title bold text-center w-100">{{$demandUser->name}}様に採用通知を送信します</div>
            ...
            <form id="job_apply_popup_form" method="POST" action="/job/applicant/update/{{$encrypt}}">
                ...
                <div class="modal-body">
                    <div class="form-group row form-group-list">
                        <div class="col-sm-12">
                            ...
                            <div class="col-sm-12 p-t-15 p-b-15 m-b-15 border-part"  id="error-sys-are">
                                <p class="m-b-0">・「ステータスを採用に変更する」を押下すると応募者に採用通知が届きます。</p>
                    ...
                    <div class="row-bottom text-center close-btn">
                        ...
                        <button type="button" class="btn btn-primary mgt-20 bold popup-submit-form-ajax" submit-ajax="true" data-form-id="job_apply_popup_form">{{__('ステータスを採用に変更して、採用通知を送信する')}}</button>
                    </div>
                </div>
            </form>
        </div>
