                    ...
                    <div class="form-group row form-group-list">
                        <div class="col-sm-12">
                            ...
                            <div class="col-sm-12 p-t-15 p-b-15 m-b-15 border-part"  id="error-sys-are">
                                <p class="m-b-0">・「ステータスを内定取消に変更する」を押下すると、応募者に内定取消通知が送信されます。一度変更したステータスは変更することができません</p>
                                <p class="m-b-0">・内定取消事由、備考の記述内容は応募者に通知されます。</p>
                                <p class="m-b-0">・内定取消は、内定後に、雇用する企業にとって著しく不利益な状態になると判明した場合にのみ認められます。客観的に見て合理的な理由がない場合、　社会通念上認められない場合、内定取消は無効となります。</p>
