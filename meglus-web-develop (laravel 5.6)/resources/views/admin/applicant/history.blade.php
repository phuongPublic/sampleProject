                ...
                <!-- Content -->
                    ...
                    <table class="table">
                        ...
                        <tr class="text-center">
                            <th scope="col"></th>
                            <th scope="col" class="text-left"><a href="javascript:void(0)" class="multiple-sort-applicant" {{Supply::makeDataAttr($sort,'name')}}>名前</a></th>
                            <th scope="col" class="" width="150"><a href="javascript:void(0)" class="multiple-sort-applicant" {{Supply::makeDataAttr($sort,'seq')}}>シーケンス</a></th>
                            <th scope="col" class="" width="150"><a href="javascript:void(0)" class="multiple-sort-applicant" {{Supply::makeDataAttr($sort,'seq_update_dt')}}>採用日時</a></th>
                            <th scope="col" class="" width="250"><a href="javascript:void(0)" class="multiple-sort-applicant" {{Supply::makeDataAttr($sort,'workplace_name')}}>勤務先名</a></th>
                            <th scope="col" class="" width="150"><a href="javascript:void(0)" class="multiple-sort-applicant" {{Supply::makeDataAttr($sort,'job_category_cd')}}>職種</a></th>
                            <th scope="col" class="" width="250"><a href="javascript:void(0)" class="multiple-sort-applicant" {{Supply::makeDataAttr($sort,'job_discription_cd')}}>職務内容</a></th>
                            <th scope="col" class="color-blue">アクション</th>
                        </tr>
                        </thead>
                        <tbody>
