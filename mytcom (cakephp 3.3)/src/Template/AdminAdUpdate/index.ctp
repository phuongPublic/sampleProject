                ...
                <div id="BackgroundRight_repeat">
                    <div id="BackgroundLeft">
                        <div id="BackgroundRight">
                            <div id="siteNavi">
                                <div id="topicPath"><span><a href="/admin/index.html">トップ</a></span>&nbsp;&gt;&nbsp;<span>広告の編集</span></div>
                            </div>
                            <div id="wrap">
                                    ...
                                    <tr>
                                        ...
                                        <td id="main"><div class="mainBox">
                                                <div class="titlebarMain_bg">
                                                    <h2 class="titlebarMain_icon">広告の編集</h2>
                                                </div>
                                                <p class="mBoxitem_txt">広告を編集します。<br />
                                                    ...
                                                    <form id="form" method="post" enctype="multipart/form-data" name="ad" action="">
                                                        <table cellspacing="0" cellpadding="0" border="0" class="tableTate">
                                                            <tr>
                                                                ...
                                                                <td><p class="fTextAssist_top txtSub">一覧での参照用に名前をつけることができます。</p>
                                                                    ...
                                                                    <input type="text" name="title" class="txtbox" onblur="toggleColor(this)" onfocus="toggleColor(this)" onkeydown="ignoreESC(this,event.keyCode)" style="width:400px;" value="<?= $adData['title'] ?>"/>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <div class="fAssist_col_line">
                                                                        <?= $this->Form->year('openData', [
                                                                                'value' => ($adData['viewFlg'] !=2 ) ? $adData['openData']->i18nFormat('YYYY') : date(Configure::read('Common.AdminModule.Datetime.DefaultSelected.Year')),
                                                                        ...
                                                                        <?= $this->Form->month('openData', [
                                                                                'value' => ($adData['viewFlg'] !=2 ) ? $adData['openData']->i18nFormat('MM') : date(Configure::read('Common.AdminModule.Datetime.DefaultSelected.Month')),
                                                                                'empty' => false,
                                                                                'monthNames' => false,
                                                                        ...
                                                                        <?= $this->Form->day('openData', [
                                                                                'value' => ($adData['viewFlg'] !=2 ) ? $adData['openData']->i18nFormat('dd') : date(Configure::read('Common.AdminModule.Datetime.DefaultSelected.Day')),
                                                                                'empty' => false,
                                                                                'leadingZeroValue' => true,
                                                                                'class' => 'startOpenDate'
                                                                            ]);
                                                                        ...
                                                                        <?= $this->Form->hour('openData', [
                                                                                'value' => ($adData['viewFlg'] !=2 ) ? $adData['openData']->i18nFormat('HH') : date(Configure::read('Common.AdminModule.Datetime.DefaultSelected.Hour')),
                                                                                'empty' => false,
                                                                                'format' => 24,
                                                                                'leadingZeroValue' => true,
                                                                                'class' => 'startOpenDate'
                                                                        ...
                                                                        <?= $this->Form->minute('openData', [
                                                                                'value' => ($adData['viewFlg'] !=2 ) ? $adData['openData']->i18nFormat('mm') : date(Configure::read('Common.AdminModule.Datetime.DefaultSelected.Minute')),
                                                                                'empty' => false,
                                                                                'class' => 'startOpenDate'
                                                                            ]);
                                                                        ?>
                                                            ...
                                                            <tr>
                                                                <th>公開終了日時</th>
                                                                <td><?php if (isset($error['timerData'])) : ?>
                                                                        <div class="txtWarning space_5">
                                                                    ...
                                                                    <div class="fAssist_col_line">
                                                                        <?= $this->Form->year('timerData', [
                                                                                'value' => ($adData['timerFlg'] == 1) ? $adData['timerData']->i18nFormat('YYYY') : date(Configure::read('Common.AdminModule.Datetime.DefaultSelected.Year')),
                                                                                'minYear' => Configure::read('Common.AdminModule.Datetime.DefaultSelected.Year'),
                                                                                'maxYear' => date('Y') + 3,
                                                                                'orderYear' => 'asc',
                                                                                'empty' => false,
                                                                        ...
                                                                        <?= $this->Form->month('timerData', [
                                                                                'value' => ($adData['timerFlg'] == 1) ? $adData['timerData']->i18nFormat('MM') : date(Configure::read('Common.AdminModule.Datetime.DefaultSelected.Month')),
                                                                                'empty' => false,
                                                                                'monthNames' => false,
                                                                                'leadingZeroValue' => true,
                                                                                'class' => 'endOpenDate'
                                                                        ...
                                                                        <?= $this->Form->day('timerData', [
                                                                                'value' => ($adData['timerFlg'] == 1) ? $adData['timerData']->i18nFormat('dd') : date(Configure::read('Common.AdminModule.Datetime.DefaultSelected.Day')),
                                                                                'empty' => false,
                                                                                'leadingZeroValue' => true,
                                                                                'class' => 'endOpenDate'
                                                                            ]);
                                                                        ...
                                                                        <?= $this->Form->hour('timerData', [
                                                                                'value' => ($adData['timerFlg'] == 1) ? $adData['timerData']->i18nFormat('HH') : date(Configure::read('Common.AdminModule.Datetime.DefaultSelected.Hour')),
                                                                                'empty' => false,
                                                                                'format' => 24,
                                                                                'leadingZeroValue' => true,
                                                                                'class' => 'endOpenDate'
                                                                        ...
                                                                        <?= $this->Form->minute('timerData', [
                                                                                'value' => ($adData['timerFlg'] == 1) ? $adData['timerData']->i18nFormat('mm') : date(Configure::read('Common.AdminModule.Datetime.DefaultSelected.Minute')),
                                                                                'empty' => false,
                                                                                'class' => 'endOpenDate'
                                                                            ]);
                                                                        ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    画像を変更する場合は、[参照]をクリックして新しい画像を再度登録してください。<br />
                                                        ...
                                                        <div class="BtnArea">
                                                            <div class="BtnAreaitem">
                                                                <input type="submit" id="toggleSubmit" class="btnNormal_xbig" title="書き込み内容をよく確認してから登録する" value="書き込み内容をよく確認してから登録する" name="action_ads_update" />
                                                                <input type="hidden" name="adseq" value="<?= $adData['adseq'] ?>"/>
                                                            </div>
                                                            <div class="BtnAreaitem">
