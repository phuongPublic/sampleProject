...
/**
 * App\Controller\OpenContentsController Test Case
 */
class OpenContentsControllerTest extends NoptIntegrationTestCase
{
    ...
    public function index()
    {
        ...
        try {
            $this->switchDevice(1);
            $this->get($this->testUrl . '?id=open_id&pid=1');
        } catch (\Exception $e) {
            $result = false;
        }
        ...
        try {
            $this->switchDevice(2);
            $this->setSession();
            $this->get($this->testUrl . '?id=open_id&cid=1');
        } catch (\Exception $e) {
            $result = false;
        }
        $this->assertTrue($result);
        ...
        try {
            $this->switchDevice(1);
            $this->setSession();
            $this->get($this->testUrl . '?id=open_id&cid=3');
        } catch (\Exception $e) {
            $result = false;
        }
        $this->assertTrue($result);
