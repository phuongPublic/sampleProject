...
<?php if (isset($deviceTypeId)) { ?>
    <title><?php echo $this->Header->getTitleStr($menu_now_flg) ?>｜My@T COM（マイアットティーコム）</title>
<?php } else { ?>
...
<script type="text/javascript" src="/contents/android/tcom/iui/iui.js"></script>
...
<script type="text/javascript" src="/contents/iphone/tcom/iui/iui.js"></script>
...
<link type="text/css" id="green" rel="stylesheet" media="screen" title="green" href="/contents/css/tcom/common_green.css?c=new" disabled="true"/>
<link type="text/css" id="pink" rel="stylesheet" media="screen" title="green" href="/contents/css/tcom/common_pink.css?c=new" disabled="true"/>
<link type="text/css" id="gray" rel="stylesheet" media="screen" title="green" href="/contents/css/tcom/common_gray.css?c=new" disabled="true"/>
<link type="text/css" id="orange" rel="stylesheet" media="screen" title="green" href="/contents/css/tcom/common_orange.css?c=new" disabled="true"/>
<link type="text/css" id="white" rel="stylesheet" media="screen" title="green" href="/contents/css/tcom/common_white.css?c=new" disabled="true"/>
<link type="text/css" id="none" rel="stylesheet" href="/contents/css/tcom/common.css?c=new" />
<link type="text/css" id="blue" rel="stylesheet" href="/contents/css/tcom/common.css?c=new" />
...
<?php elseif ($deviceTypeId == 3) : ?>
<link type="text/css" rel="stylesheet" href="/contents/android/tcom/iui/iui.css" />
<link type="text/css" rel="stylesheet" href="/contents/android/tcom/css/common.css" />
<?php elseif ($deviceTypeId == 2) : ?>
